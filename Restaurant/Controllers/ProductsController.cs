...
namespace Restaurant.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Sale,Price,Categoryid")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Name,Sale,Price,Categoryid")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
